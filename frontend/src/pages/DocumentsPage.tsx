...
import { archiveDocument, DOCUMENT_ACCEPT, fetchDocuments, searchDocuments, uploadDocument } from '../api/documents';
import type { DocumentItem, DocumentSearchResult } from '../api/documents';
import DocumentLinkPanel from '../components/DocumentLinkPanel';
import DocumentProposalPanel from '../components/DocumentProposalPanel';

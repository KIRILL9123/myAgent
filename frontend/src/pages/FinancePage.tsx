...
import type { Transaction, FinanceSummary } from '../api/finance';
        ...
        <div className="flex-1 w-full p-6">
          {loading ? (
            ...
            <div className="w-full max-w-md mx-auto h-64 flex flex-col items-center justify-center gap-4 text-center border border-zinc-900 border-dashed rounded-2xl bg-zinc-950/20 px-6 mt-6">
              <Wallet className="h-10 w-10 text-zinc-650" />
              <div>
                <h3 className="text-sm font-semibold text-zinc-300">Транзакции отсутствуют</h3>
                <p className="text-zinc-500 text-xs mt-1">Нет финансовых записей за выбранный период времени.</p>
              </div>
              <button 
                onClick={handleOpenCreate}
                  ...
                  <div className="flex flex-col gap-3.5">
                    ...
                    <div className="flex justify-between items-start gap-4">
                      <div className="flex items-center gap-3 min-w-0">
                        ...
                        <h2 className="text-sm font-semibold text-zinc-200 tracking-wide truncate">
                          {tx.category}
                        </h2>
                      </div>
            ...
            <form onSubmit={handleFormSubmit} className="flex flex-col gap-4.5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-zinc-950 border border-zinc-850 focus:border-emerald-500 rounded-xl px-4 py-2.5 text-xs text-zinc-100 placeholder-zinc-500 focus:outline-none transition-all font-mono"
                />
              </div>
              ...
              <div className="flex gap-3 justify-end border-t border-zinc-800/40 pt-4 mt-1.5">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="flex items-center gap-1.5 bg-emerald-600 hover:bg-emerald-500 disabled:bg-emerald-850 active:bg-emerald-700 text-zinc-100 rounded-xl px-5 py-2.5 text-xs font-semibold tracking-wide transition-all shadow-md shadow-emerald-950/20"
                >
